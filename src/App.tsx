...
function AppContent() {
  ...
  const installApp = async () => {
    ...
    if (deferredPrompt) {
      ...
      // Browser didn't trigger prompt event yet, guide them directly
      alert("Por favor, pulsa el menú de opciones de tu navegador (los tres puntos ⋮ o el botón compartir) y selecciona 'Instalar aplicación' o 'Agregar a pantalla de inicio'.");
    }
  };
